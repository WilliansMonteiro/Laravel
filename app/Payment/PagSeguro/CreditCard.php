...
class CreditCard
{
    ...
    public function doPayment()
    {
        ...
        $creditCard->setReceiverEmail(env('PGSEURO_EMAIL'));
        ...
        list($quantity, $instalmentAmount) = explode('|', $this->cardInfo['installment']);
        $instalmentAmount = number_format($instalmentAmount, 2, '.', '');
        $creditCard->setInstallment()->withParameters($quantity, $instalmentAmount);
